...
from ..modules.fused_moe import RenormalizeMoeRoutingMethod, create_moe, MoEPrefetchProxy
...
class MixtralModel(DecoderModel):
    ...
    def __init__(self, model_config: ModelConfig[PretrainedConfig]):
        ...
        self.layers = nn.ModuleList([
            MixtralDecoderLayer(model_config, layer_idx, self.aux_stream, self.moe_prefetch_proxy_list[layer_idx])
